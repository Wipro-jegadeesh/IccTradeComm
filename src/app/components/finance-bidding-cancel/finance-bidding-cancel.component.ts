...
import { InvoiceDetailsCancelComponent } from './invoice-details-cancel/invoice-details-cancel.component'
...
@Component({
  selector: 'app-finance-bidding-cancel',
  templateUrl: './finance-bidding-cancel.component.html',
  styleUrls: ['./finance-bidding-cancel.component.scss']
})
export class FinanceBiddingCancelComponent implements OnInit {
  @Input() InvoiceDetailsRejectedComponent: InvoiceDetailsCancelComponent;
 
  constructor(private fb: FormBuilder,public router: Router, public authenticationService: AuthenticationService,
    private modalService: BsModalService, private FinanceBiddingRejectedServices: FinanceBiddingCancelServices, private FinanceBiddingService: FinanceBiddingService) { }
